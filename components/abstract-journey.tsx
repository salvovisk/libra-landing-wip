...
export function AbstractJourney() {
    ...
    >
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-primary backdrop-blur-md">
            Cosa fa Libra Colf per te
          </div>
          <h2 className="text-balance text-4xl font-extrabold tracking-[-0.05em] text-ink sm:text-5xl">
            Dalla creazione del rapporto alle scadenze di fine anno
          </h2>
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(420px,1fr)]">
          {/* LEFT — stepper (pattern from WorkflowSection) */}
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="mt-4 max-w-xl text-base leading-8 text-slate-600">{step.subtext}</p>
                    </div>

                    {/* Mobile inline theater */}
                    <div className="mt-6 lg:hidden">
                      <Theater active={index} total={STEPS.length} compact />
                    </div>
                  </div>
                );
              })}
  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(0,55,126,0.08) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,55,126,0.08) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(0,55,126,0.25), transparent 70%)" }}
      />
    </>
  );
}
...
export default AbstractJourney;
