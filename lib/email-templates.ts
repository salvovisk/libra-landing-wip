...
const GUIDE_PDF_URL = `${SITE_URL}/guida-libra-colf.pdf`;
...
export const emailTemplatePreviews: EmailTemplatePreview[] = [
  {
    id: "guide-delivery",
    label: "Invio guida PDF",
    subject: "Ecco la guida gratuita di Libra Colf",
    preheader: "Scarica la guida con obblighi, scadenze INPS e busta paga.",
    ctaHref: GUIDE_PDF_URL,
    html: renderEmailShell({
      preheader: "Scarica la guida con obblighi, scadenze INPS e busta paga.",
      eyebrow: "Guida gratuita",
      title: "La tua guida è pronta.",
      intro:
        "Un riepilogo chiaro per gestire lavoro domestico, buste paga e scadenze senza rincorrere informazioni sparse.",
      bodyHtml: `
        <p style="margin:0 0 14px;">Ciao,</p>
        <p style="margin:0 0 14px;">come promesso, trovi qui la guida gratuita di Libra Colf con gli adempimenti principali per chi gestisce una colf o una badante.</p>
        <p style="margin:0 0 14px;">Abbiamo raccolto in un unico file i passaggi che generano più dubbi o ritardi, così puoi avere subito un quadro ordinato.</p>
        <p style="margin:0;">Se dopo la lettura vuoi vedere come Libra automatizza questi passaggi, puoi richiedere una demo dedicata.</p>
      `,
      ctaLabel: "Scarica la guida PDF",
      ctaHref: GUIDE_PDF_URL,
      summaryItems: [
        {
          title: "Dentro la guida",
          text: "Obblighi contrattuali, scadenze INPS, busta paga, TFR, tredicesima ed errori ricorrenti da evitare.",
        },
        {
          title: "Quando usarla",
          text: "Prima di iniziare un rapporto di lavoro o per verificare che la gestione attuale sia corretta.",
        },
      ],
      footerNote:
        "Hai ricevuto questa email perché hai richiesto la guida gratuita di Libra Colf. Nessuno spam, solo contenuti pertinenti.",
    }),
  },
  {
    id: "demo-confirmation",
    label: "Conferma demo",
    subject: "Abbiamo ricevuto la tua richiesta demo",
    preheader: "Ti contatteremo a breve per organizzare la demo di Libra Colf.",
    ctaHref: "",
    html: renderEmailShell({
      preheader: "Ti contatteremo a breve per organizzare la demo di Libra Colf.",
      ...
      intro:
        "Ti contatteremo a breve per trovare il momento giusto e mostrarti Libra Colf sul tuo caso operativo.",
      bodyHtml: `
        <p style="margin:0 0 14px;">Grazie per aver richiesto una demo di Libra Colf.</p>
        <p style="margin:0 0 14px;">Useremo la chiamata per mostrarti il prodotto in modo pratico, senza una presentazione generica: vedremo insieme i passaggi che oggi richiedono più tempo o generano più dubbi.</p>
        <p style="margin:0;">Nel frattempo puoi rivedere funzionalità, prezzi e materiali informativi sulla landing.</p>
      `,
      summaryItems: [
        {
          title: "Cosa vedrai",
          text: "Contratti, variazioni, buste paga, contributi INPS e documenti gestiti in un unico flusso.",
        },
        {
          title: "Approccio",
          text: "Una demo breve e concreta, focalizzata sul tuo contesto, non un tour generico del prodotto.",
        },
      ],
      footerNote:
        "Se non hai richiesto tu questa demo, puoi ignorare il messaggio: non verranno effettuate altre azioni.",
    }),
  },
];
